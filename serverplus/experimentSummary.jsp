                                                ...
                                                if (rs != null) {
                                                    while (rs.next()) {
                                                        ...
                                                        if (rs.getString("expover").equals("1")) {
                                                            out.write("<tr><td>" + count + "</td><td>" + rs.getString("macaddress") + "</td><td>" + rs.getString("bssid") + "</td><td>" + rs.getString("controlfilesendDate") + "</td><td>" + rs.getString("expoverDate") + "</td></tr>");
                                                        }
                                                    }
                                                }
                                            %>                
