...
//                out.write("<tr><th>Exp No</th><th>Control File</th><th>Start Time</th><th>End Time</th><th>EXp Name</th><th>Exp Location</th><th>Description</th></tr>");
                while (rs.next()) {
                    ...
                    if (rs.getString(3) == "" || rs.getString(3) == null) {
                        out.write("<tr><td  style='display: none'></td><td><a href=\"experimentView.jsp?expid=" + rs.getString(1) + "\">" + rs.getString(1) + "</a></td>"
                                + "<td><a href=\"download.jsp?path=" + path + "&expid=" + rs.getString(1) + "&name=config.txt" + "\" >" + "download" + "</a>"
                                + "</td>"
                                + "<td>" + rs.getString(2) + "</td><td>--not-stopped--</td><td>" + rs.getString(4) + "</td><td>" + rs.getString(5) + "</td><td>" + rs.getString(6) + "</td></tr>");
                    } else {
                        out.write("<tr><td  style='display: none'></td><td><a href=\"experimentView.jsp?expid=" + rs.getString(1) + "\">" + rs.getString(1) + "</a></td>"
                                + "<td><a href=\"download.jsp?path=" + path + "&expid=" + rs.getString(1) + "&name=config.txt" + "\" >" + "download" + "</a>"
                                + "</td>"
                                + "<td>" + rs.getString(2) + "</td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td><td>" + rs.getString(5) + "</td><td>" + rs.getString(6) + "</td></tr>");
                    }
