                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <b><%out.write("<h2 class='heading'>Experiment No.   " + expid + "</h2>"); %></b>
                            </div>
                            <!-- /.panel-heading -->
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            if (rs != null) {
//                                                out.write("<table>");
//                                                out.write("<tr><th>Mac Address</th><th>RSSI</th><th>BSSID</th><th>SSID</th><th>Log File Received</th><th>Control File</th><th>Control File Sent</th><th>Experiment Over</th><th>Status</th></tr>");
                                                //             select macaddress,controlfilesend,rssi,bssid,ssid,expover,status from experimentdetails where expid=44 order by bssid;  
                                                while (rs.next()) {
                                                    out.write("<tr><td><a href=experimentDeviceInformation.jsp?macAddr=" + rs.getString(1) + "&expId=" + expid + ">" + rs.getString(1) + "</a></td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td><td>" + rs.getString(5) + "</td><td>"
                                                            + (rs.getString(8).equals("1") ? "<a href=\"download.jsp?path=" + path + "&expid=" + expid + "&name=" + rs.getString(1) + "\" >" + "Received" + "</a>" : "Not Received")
                                                            + ("</td><td><a href=\"download.jsp?path=" + path + "&expid=" + expid + "&name=" + rs.getString(1) + "_confFile" + "\" >" + "download" + "</a>")
                                                            /*
