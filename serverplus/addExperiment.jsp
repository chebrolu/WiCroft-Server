            ...
            <div id="page-wrapper">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form"  action="addExperimentHandler.jsp" method="get" >
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                AccessPoint Connection Information
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
...
while (detail.hasMoreElements()) {
  ...
  String info[] = ssid_count.split("#");
   out.write("<tr><td>"+count+"</td><td>" + bssid + "</td><td>" + info[0] + "</td><td>" + info[1] + "</td></tr>");
