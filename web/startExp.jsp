<%-- 
    Document   : startExp
    Created on : 17 Jan, 2017, 11:33:56 PM
    Author     : ratheeshkv
--%>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form"  action="startExpHandler.jsp" method="get" >
                                            ...
                                            <div class="form-group">
                                                <label>Choose Control File <b style='color: red'>*</b></label>
                                                
                                                <%
                                                    out.write("<select class='form-control' id='fileName' name='file_name'>");
                                                            out.write("<option value='' disabled>Choose File</option>");                                 
                                                            if(rs != null){
                                                                while(rs.next()){
                                                                    
                                                                    out.write("<option value='"+rs.getString("fileid")+"_"+rs.getString("filename")+"'>"+rs.getString("fileid")+"&emsp;|&emsp;"+rs.getString("filename")+"&emsp;|&emsp;"+rs.getString("filedate")+"</option>");
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-default panel panel-green" id='getclient' name='getclient' value="Proceed >>"  style="display: none"/>
                                            </div>
