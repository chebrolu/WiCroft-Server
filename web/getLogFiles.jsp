...
//            mySession.setFetchingLogFilesStatus(true);
            Utils.requestLogFiles(numOfClients, roundDuration, mySession);

/*
           for(int i=0;i<mySession.getRequestLogFileFilteredClients().size();i++){
                mySession.getRequestLogFileFilteredClients().get(i);
            }
*/
            ...
            for (String cl : name) { // 1_macAddress form
                ...
                Utils.requestLogFiles(clients, time, );
            }*/
