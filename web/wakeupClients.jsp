<%-- 
    Document   : wakeupClients
    Created on : 10 Mar, 2017, 11:10:07 AM
    Author     : ratheeshkv
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%
                if (Constants.currentSession.isWakeUpStatus()) {
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form"  action="wakeupClientsHandler.jsp" method="get" >
