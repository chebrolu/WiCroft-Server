                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="timeout" name="expBuffTime">
                                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" type="text" id="expName" name="nbrReq"/><i style='color:red;display: none' id='error'>Field Cannot be Empty</i>
                                </div>


                                <div class="form-group">
                                    <label>Duration between Rounds (in seconds)<b style='color: red'>*</b></label>
                                    <input  class="form-control" type="text" id="expName" name="roundDur"/><i style='color:red;display: none' id='error'>Field Cannot be Empty</i>
                                </div>
