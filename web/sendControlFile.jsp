<%-- 
    Document   : sendControlFile
    Created on : 17 Jan, 2017, 9:17:24 PM
    Author     : cse
--%>
...
//                if (Constants.currentSession.isExperimentRunning()) {
                if (Constants.currentSession.isSendingControlFile()) {
                    response.sendRedirect("controlFileStatus.jsp");
                } else {
                        
                ResultSet rs = DBManager.getControlFileInfo();  
//                request.setAttribute("myname","ratheesh");
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <form role="form"  action="sendControlFileHandler.jsp" method="get" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name='OldorNew' id='OldorNew' onchange="__check(this)">
                                                    <option value="selectNewFile" >Send New Control File</option>
                                                    <option value="selectOldFile" >Reuse Control file</option>
                                                </select>
                                            </div>    
                                                

                                            <div class="form-group">
                                                <label  id='OldFIleLabel'  style="display: none" >Choose Control File <b style='color: red'>*</b></label>
                                                <%
                                                     out.write("<select class='form-control' id='fileName' name='file_name' style='display: none'>");
 ...
 //                                                                    out.write("<option value='"+rs.getString("fileid")+"_"+rs.getString("filename")+"'>"+rs.getString("fileid")+"&emsp;|&emsp;"+rs.getString("filename")+"&emsp;|&emsp;"+rs.getString("filedate")+"&emsp;|&emsp;"+rs.getString("description")+"</option>");
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class="btn btn-default panel panel-green" id='getclient' name='getclient' value="Get_Clients"  style="display: none"/>
                                            </div>
