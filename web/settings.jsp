                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5"  >
                                                <table  style="overflow: auto;width: 100%; height:500px;display: block"  class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody > -->
                                                    <%
                                                            ...
                                                            while (bssList.hasMoreElements()) {
                                                                count += 1;
                                                                String b = bssList.nextElement();
//                                                                System.out.println(b + ":" + initilizeServer.allBssidInfo.get(b));
                                                                out.write("<tr><td>"+count+"</td><td>"+b+"</td><td>"+initilizeServer.allBssidInfo.get(b)+"</td></tr>");
                                                            }
                                                            */
//                                                            mySession.selectedBssidInfo.clearA);
//                                                            Enumeration<String> bssList1 = Constants.currentSession.allBssidInfo.keys();
...
//                                                                    out.write("<tr><td>"+count1+"</td><td>"+ssid+"</td><td>"+bssidlist.get(i)+"</td></tr>");
                                                ...
                                                <div class="col-lg-5" >
                                                    <table  style="overflow: auto;height:600px;display: block"  class="table table-striped table-bordered table-hover" >
                                                <!-- <thead style="display: block"> -->
                                                ...
                                                <!-- </thead>
                                                <tbody style="overflow: auto;height: 500px;display: block" > -->
                                                    <%
                                                            /*
                                                            Enumeration<String> bssList = initilizeServer.allBssidInfo.keys();
                                                            int count = 0 ;    
...
//                                                            out.write(initilizeServer.allBssidInfo.size());
                                                            Enumeration<String> bssList = initilizeServer.allBssidInfo.keys();
                            ...
                            <div class="tab-content">
                                ...
                                <form action='accountSettings.jsp' method='get' onsubmit="return checkCreateAccFields()">    
                                    <table   class="table  table-hover">
                                        ...
                                        <tr><td></td><td><input class='btn btn-default' type='submit' name='action' value='Create Account'/></td></tr>
                                    </table>
                                </form>
                                </div>
                                ...
                                <form action='accountSettings.jsp' method='get' onsubmit="return checkDeleteAccFields()">
                                    <!-- <input type="text" style="visibility: hidden;" name="currentUser" value="<%=username%>"> -->
                                      <table   class="table table-hover">
                                        ...
                                        <tr><td></td><td><input  class='btn btn-default' type='submit'  name='action' value='Delete Account'/></td></tr>
                                    </table>
                                </form>
                                </div>
                                ...
                                <form action='accountSettings.jsp' method='get' onsubmit="return checkChangePwdFields()">
                                      <table   class="table table-hover">
                                        <tr><td>Old &nbsp;Password</td><td><input class="form-control" id="changepwd1" type='password' name='oldpassword'/></td></tr>
                                        <tr><td>New &nbsp;Password</td><td><input class="form-control" id="changepwd2" type='password' name='resetpassword'/></td></tr>
                                        <tr><td></td><td><input  class='btn btn-default' type='submit'  name='action' value='Change Password'/></td></tr>
                                    </table>
                                </form> 
                                </div>
...
-->
        ...
        //     alert(document.getElementById("createAccusername").value +" : "+ document.getElementById("createAccpwd").value);
        //     return false;
        // }

        // function checkDeleteAccFields(){
        //     alert(document.getElementById("currentUser").value +" : "+ document.getElementById("deleteAccpwd").value);
        //     return false;
        // } 

        // function checkChangePwdFields(){
        //     alert(document.getElementById("changepwd1").value +" : "+ document.getElementById("changepwd2").value);
        //     return false;
        // }
